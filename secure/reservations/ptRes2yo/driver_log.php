...
<h3><?= $date ?></h3>
<a href="http://www.planettran.com/stg/ptRes/driver_tasks.php?driverId=<?= $driverId?>">Tasks Schedule</a>
<h3><?= $actionmessage ?></h3>
<?
}
...
<input name="action" type="submit" value="ClockIn">
<?
...
?>
car: <select name="carId"  id="carId" onchange="javascript:sndReq('vitals',this.value)">
...
<option value="109">PT014</option>
<option value="110">PT015</option>
<option value="115">PT016</option>
<option value="116">PT017</option>
</select>
<br>
<div id="vitals">Mileage:<input type="text" name="mileage" value="" size="6" maxlength="6" id="mileage">
Cash:<input type="text" name="cash" value="" size="3" maxlength="3" id="cash">
<br>Tires:<input type="text" name="tires" value="df=40dr=40pf=40pr=40" size="20" maxlength="20" id="tires"><br></div>
