...
{
	//var backgroundDiv = "<div id='loading_div' style='background: #FFFFFF;position: absolute; top: 100; left: 100; z-index: 1; width: 100; vertical-align:middle;'><img style='position:absolute;left:50px; top:400px;' src='loading.gif'></img></div>";
	//	$('body').append(backgroundDiv);
	//$('#loading_div').css('height',$(document).height());

	var fromAddr = document.quickquote.fromAddr.value;
	var fromCity = document.quickquote.fromCity.value;
	var toAddr = document.quickquote.toAddr.value;
	var toCity = document.quickquote.toCity.value;
	var fromZip = document.quickquote.fromZip.value;
	var toZip = document.quickquote.toZip.value;
	var airport = document.quickquote.airport.value;
	
	sfp = "fromAddr=" + fromAddr + "&fromCity=" + fromCity + "&fromZip=" + fromZip + "&toAddr=" + toAddr + "&toCity=" + toCity + "&toZip=" + toZip + "&airport=" + airport + "&script=" + <?=get_script()?> + "&groupid=" + <?=get_groupid()?>;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<?=$manualLink?>
        <form action="" method="GET" name="quickquote" id="quickquote" onsubmit="return checkZip();">
