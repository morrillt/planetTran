...
session_set_cookie_params(0, '/', '.planettran.com');

$conf['app']['domain'] = 'http://secure.planettran.com';
//$conf['app']['weburi'] = $conf['app']['domain'].'/reservations/ptRes';
$conf['app']['weburi'] = $securePrefix;

//$conf['app']['include_path'] = '/home/planet/www/secure/';
$conf['app']['include_path'] = dirname(__FILE__).'/../../../';
//$conf['app']['include_path'] = 'C:/AppServ/www/planettran/secure/';

$conf['app']['temp_path'] = '/home/planet/tmp/';

$conf['app']['max_stops'] = 5;
...
define("DIS_WRITE",	8);
define("BILL_READ",	16);
define("BILL_WRITE",	32);

// Site link to be used in customer emails
$conf['app']['link'] = 'http://reservations.planettran.com';
...
$conf['ui']['announcement'][1] = "Starting Jan. 22, 2007, we will begin serving SFO and OAK in the Bay Area!  Simply add those airports to your profile below, and you can make reservations to be picked up at either airport!";
//$conf['ui']['announcement'][1] = "Create the Reservation with the link on the right side of the Reservations bar.  Choose two Locations for each Reservation, include flight details and any other special instructions.  See the Quick Link below for details about where to meet the Tran at the airport.";
$conf['ui']['announcement'][0] = "Make sure your Profile contains a cell-phone number, and put 1-888-PLNT-TRN (888-756-8876) in your phone's memory.";
