...
$strings['reserved or unavailable'] = '%s da %s a %s è riservata o indisponibile.';
...
$email['new_password'] = "%s,\r\n"
            . "La tua nuova password per l account %s è:\r\n\r\n"
            . "%s\r\n\r\n"
            . "Prego loggati in %s "
            . "con questa password "
            ...
            . "Ogni domanda può essere rivolta a %s.";
?>