...
$strings['Manage My Email Preferences'] = 'Muokkaa sähköpostiasetuksia';
...
$strings['reserved or unavailable'] = 'Aika välillä %s ja %s to %s on varattu tai ei käytettävissä.';
...
$email['register'] = "%s, %s \r\n\r\n"
				. "Olet rekisteröitynyt seuraavin tiedoin:\r\n"
				. "Nimi %s %s \r\n"
				. "Puhelin: %s\r\n"
				. "Järjestö/yritys: %s \r\n"
				. "Toimenkuva: %s \r\n\r\n"
				...
				. "%s \r\n\r\n"
				. "Linkit online-aikatauluun ja profiilin muokkaukseen löytyvät Ohjauspaneelista.\r\n\r\n"
				. "Kysymykset resurssien ja varausten käytöstä ottaa käsittelee %s";
...
$email['reservation_activity_1'] = "%s,\r\n<br />"
			...
			. "Käytä tätä varausnumeroa ottaessasi esittäessäsi kysymyksiä ylläpitäjälle.\r\n<br/><br/>"
			. "Varaus päivälle %s, välillä %s ja %s, kohteena \"%s\", \"%s\" on %s.\r\n<br/><br/>";
