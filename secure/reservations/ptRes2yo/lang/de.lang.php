...
* @translator Ilja Kogan <ilja@linux.io>
...
$months_abbr = array('Jan', 'Feb', 'MÃ¤r', 'Apr', 'Mai', 'Jun', 'Jul', 'Aug', 'Sep', 'Okt', 'Nov', 'Dez');
...
$strings['Password (6 char min)'] = 'Passwort (Mind. 6 Zeichen)';
...
$strings['Go to the Online Scheduler'] = 'Zum Zeitplan gehen';
$strings['Change My Profile Information/Password'] = 'Meine Profil Informationen und Passwort ändern';
$strings['Manage My Email Preferences'] = 'E-Mail-Einstellungen verwalten';
...
$strings['Database backend'] = 'Datenbank Bbackend:';
...
$strings['Min 6 character password is required.'] = '- Ein Passwort mit mind. 6 Zeichen wird benötigt.';
...
$strings['reserved or unavailable'] = '%s von %s bis %s ist reserviert oder nicht verfügbar.';
...
$strings['Sorry, we could not find that user in the database.'] = 'Leider konnten wurd diesen Benutzer nicht in der Datenbank finden.';
...
$email['register'] = "%s, %s\n\r\n"
				. "Die haben sich erfolgreich, mit den folgenden Daten, registriert:\r\n"
				. "Name: %s %s\r\n"
				. "Tel: %s\r\n"
				. "Institution: %s\r\n"
				. "Stellung: %s\r\n\r\n"
...
$email['reservation_activity_1'] = "%s,\r\n<br />"
			...
			. "Eine Reservierung vonn %s zwischen %s und %s für %s"
...
$email['reservation_activity_4'] = "Die folgende Zusammenfassung wurde geliefert fü diese Reservierung: \r\n<br/>%s\r\n\r\n<br/><br/>";
$email['reservation_activity_5'] = "Wenn das ein Fehler sein sollte, bitte kontaktieren Sie den Administrator über : %s"
