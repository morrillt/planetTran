<?php
setlocale(LC_MONETARY, 'en_US');  // format money
...
$last4 = ($res['cc'] == "") ? "" : str_repeat('*',4) . substr($res['cc'], -4);
...
<tr>
	...
	<td class="col2" width="70%">$<?=money_format("%(.2n",$res['total_fare'])?></td>
</tr>

<tr>
	<td class="col1">PAYMENT:</td>
	<td class="col2"><?=$cardType." ".$last4?></td>
</tr>
...
if(false) {   /// some old test stuff if it failed.  alert someone.  can probably get removed.
