	...
	*/
	...
	function car_select_details() {
		return array(	'P'=>	array('name'=>'Standard (Prius)','select_name'=>'Standard (Prius)','seats'=>4,'suitcases'=>'3 large','price'=>0,'img'=>'vehicle_preview_prius.jpg', 'vehicle_type'=>'P', 'price_hr'=> 65),
				'V'=>	array('name'=>'Prius V','select_name'=>'Prius V ','seats'=>4,'suitcases'=>'4 large','price'=>0,'img'=>'vehicle_preview_priusV.jpg', 'vehicle_type'=>'W', 'price_hr'=> 70),
				'C'=>	array('name'=>'Camry','select_name'=>'Camry (+$10)','seats'=>4,'suitcases'=>'3 medium','price'=>10,'img'=>'vehicle_preview_camry.jpg', 'vehicle_type'=>'Y', 'price_hr'=> 70),
				'S'=>	array('name'=>'SUV (Highlander or Lexus)','select_name'=>'SUV (Highlander or Lexus [+$50])','seats'=>4,'suitcases'=>'4 large','price'=>50,'img'=>'vehicle_preview_highlander.jpg', 'vehicle_type'=>'S', 'price_hr'=> 75),
				'L'=>	array('name'=>'Luxury (Lexus HS Sedan)','select_name'=>'Luxury (Lexus HS Sedan [+$50])','seats'=>3,'suitcases'=>'3 medium' ,'price'=>50,'img'=>'vehicle_preview_luxorylexus.jpg', 'vehicle_type'=>'L', 'price_hr'=> 75,
