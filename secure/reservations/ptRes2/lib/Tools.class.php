...
class Tools {
	...
	*/
	...
	function car_select_details() {
		return array(	'P'=>	array('name'=>'Standard (Prius)','select_name'=>'Standard (Prius)','seats'=>2,'suitcases'=>3,'price'=>0,'img'=>'vehicle_preview_prius.jpg', 'vehicle_type'=>'P'),
				'V'=>	array('name'=>'Prius V','select_name'=>'Prius V (+$15)','seats'=>2,'suitcases'=>3,'price'=>15,'img'=>'vehicle_preview_priusV.jpg', 'vehicle_type'=>'W'),
				'C'=>	array('name'=>'Camry','select_name'=>'Camry (+$15)','seats'=>2,'suitcases'=>3,'price'=>15,'img'=>'vehicle_preview_camry.jpg', 'vehicle_type'=>'Y'),
				'L'=>	array('name'=>'Luxury (Lexus HS Sedan)','select_name'=>'Luxury (Lexus HS Sedan [+$30])','seats'=>2,'suitcases'=>3,'price'=>30,'img'=>'vehicle_preview_luxorylexus.jpg', 'vehicle_type'=>'L'),
				'S'=>	array('name'=>'SUV (Highlander or Lexus)','select_name'=>'SUV (Highlander or Lexus [+$30])','seats'=>2,'suitcases'=>3,'price'=>30,'img'=>'vehicle_preview_highlander.jpg', 'vehicle_type'=>'S'),
				//'N'=>	'9-Passenger van ($75/hr, 2 hr minimum)'
			);
	}
	/*
