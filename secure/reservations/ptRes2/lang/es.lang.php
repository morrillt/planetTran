...
$strings['Go to the Online Scheduler'] = 'Ver Agenda en Línea';
...
$strings['reserved or unavailable'] = '%s desde %s hasta %s ya está reservado o no está disponible.';
...
// @since 1.0.0 RC1
$strings['If no value is specified, the default password set in the config file will be used.'] = 'Si no se especifico un valor, se usará el password por defecto del archivo de configuración.';
...
$email['register'] = "%s, %s \r\n"
				...
				. "Institución: %s \r\n"
				. "Cargo: %s \r\n\r\n"
				. "Por favor incie sesión en:\r\n"
				. "%s \r\n\r\n"
				. "Encontrará accesos para la agenda en línea y podrá editar su perfil en Mi Pánel de Control.\r\n\r\n"
...
$email['reservation_activity_1'] = "%s,\r\n<br />"
			...
			. "Por favor use este número de reserva al contactar al administrador para alguna consulta.\r\n\r\n<br/><br/>"
