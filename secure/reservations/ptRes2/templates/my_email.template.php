...
?>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	  <tr>
	    <td class="tableTitle" colspan="2"><?=translate('Manage My Email Preferences')?></td></tr>
...
<?
	echo '<tr class="cellColor" style="font-weight: bold;"><td colspan="2">' . translate('Email me when') . '</td></tr>' . "\n"
		...
		. '</table>' . "\n";
?>
<input type="submit" name="submit" value="<?=translate('Save')?>" class="button" />
<input type="reset" name="reset" value="<?=translate('Reset')?>" class="button" />
<br /><br /><input type="button" name="cancel" value="<?=translate('Cancel')?>" class="button" onclick="javascript: document.location='ctrlpnl.php';" />
</form>
<?
}
